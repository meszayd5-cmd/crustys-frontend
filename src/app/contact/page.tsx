...
export default function ContactPage() {
  ...
  return (
    <div className="menu-page-container bg-[#050505] min-h-screen pb-20 md:pb-28 lg:pb-36 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex flex-col items-center">
      ...
      <div className="absolute top-[8%] left-1/2 -translate-x-1/2 w-[950px] h-[450px] bg-gradient-to-b from-[#e31c25]/5 to-transparent blur-[165px] pointer-events-none z-0" />
      <div className="absolute top-[35%] left-[-15%] w-[750px] h-[750px] bg-[#e31c25]/2.5 rounded-full blur-[210px] pointer-events-none z-0" />
      <div className="absolute bottom-[15%] right-[-15%] w-[750px] h-[750px] bg-[#ffc700]/1.5 rounded-full blur-[230px] pointer-events-none z-0" />

      {/* Cinematic Camera Vignette Overlay */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_40%,rgba(5,5,5,0.75)_100%)] pointer-events-none z-0" />

      {/* Organic Fractal Noise Overlay for Rich Atmospheric Texture */}
      <svg className="absolute inset-0 w-full h-full opacity-[0.03] pointer-events-none mix-blend-overlay z-0" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-full max-w-[1020px] mx-auto z-10 relative mt-20 md:mt-28 lg:mt-36">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div 
            className="contact-reveal-item delay-250 lg:col-span-7 bg-gradient-to-b from-[#111113]/90 via-[#0d0d0f]/95 to-[#080809]/98 backdrop-blur-2xl border border-white/[0.08] px-10 sm:px-12 md:px-14 pt-10 pb-16 sm:pb-20 rounded-[32px] relative overflow-hidden flex flex-col justify-center transition-all duration-400 ease-out"
            style={{
          ...
          >
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-12 sm:space-y-14 relative z-10 flex flex-col justify-center">
                
                {/* Fully integrated luxury header */}
                <div className="space-y-4 pb-2 pt-10 sm:pt-14 pl-2 sm:pl-4 mb-10 sm:mb-14">
                ...
                <div className="flex justify-center pt-12 sm:pt-16 pb-8 sm:pb-12">
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="group btn-shine-sweep w-full md:w-[280px] h-[56px] rounded-2xl bg-gradient-to-r from-[#e31c25] via-[#f0242d] to-[#c7121b] text-white font-black text-xs uppercase tracking-[0.3em] transition-all duration-400 ease-out shadow-[0_8px_20px_-4px_rgba(227,28,37,0.2)] hover:shadow-[0_16px_35px_rgba(227,28,37,0.35)] hover:-translate-y-1 active:translate-y-0 cursor-pointer flex items-center justify-center gap-3 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed font-body border border-white/20"
